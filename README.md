...
So inside this configuration, on [line 189](https://github.com/VonHeikemen/nvim-light/blob/main/init.lua#L89), there is a variable called `ts_parsers`, and initially it looks like this. 
